...
from boxofficex_ai import predict_movie
...
# ============================================================
# BOXOFFICEX AI PREDICTION
# ============================================================

@app.get("/ai/predict/{movie_id}")
def ai_predict_movie(movie_id: int):
    try:
        return predict_movie(movie_id)
        ...
        print(
            f"AI PREDICTION ERROR - movie_id={movie_id}:",
            e
        )
